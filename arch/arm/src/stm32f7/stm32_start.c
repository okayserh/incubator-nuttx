...
static void go_okh_start(void *sp)
{
...
void __start(void)
{
  ...
  /* If enabled reset the MPU. If start is from SDRAM,
the MPU cannot be disabled as this point as this
might disable the RAM where this code is currently
running.  */
  ...
  arm_lowputc ('E');
  go_okh_start ((FAR void *)IDLE_STACK);
  arm_lowputc ('F');
